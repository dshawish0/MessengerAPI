...
namespace Messenger.infra.Repoisitory
{
    public class FrindRepository : IFrindRepository
    {
        ...
        public void AddFrind(Frinds frind)
        {
            ...
            p.Add("@UserId", frind.UserId, dbType: DbType.Int32, direction: ParameterDirection.Input);
        ...
        public IList<Frinds> GetAllFrinds(int userId)
        {
            ...
            var result = dbContext.dbConnection.Query<Frinds>("FrindsCrud_Package.FrindsCrud", p, commandType: System.Data.CommandType.StoredProcedure);
        ...
        public Frinds GetFrindById(int userId, int reciveId)
        {
            ...
            var result = dbContext.dbConnection.Query<Frinds>("FrindsCrud_Package.getById", p, commandType: System.Data.CommandType.StoredProcedure);
